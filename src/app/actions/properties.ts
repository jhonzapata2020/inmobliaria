...
export async function upsertPropertyAction(formData: Partial<Property>): Promise<ActionResponse<Property>> {
  try {
    ...
    const payload: Record<string, unknown> = {
      ...
      commercial_appraisal_cop: formData.commercialAppraisalCop || null,
      monthly_rent_estimate_cop: formData.monthlyRentEstimateCop || null,
      occupancy_status: formData.occupancyStatus || null,
